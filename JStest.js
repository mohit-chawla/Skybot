...
// const DISCRETE_QUEUE_UNITS_SIZE = 5;

// var num_of_discrete_Q = 0, num_of_extra_req = 0;

// var numOfRequestsRecieved = 9;

// var k = numOfRequestsRecieved;



//         if(k>=DISCRETE_QUEUE_UNITS_SIZE){            
//             num_of_discrete_Q = Math.floor(k / DISCRETE_QUEUE_UNITS_SIZE);
//         }
//         num_of_extra_req = k - num_of_discrete_Q * DISCRETE_QUEUE_UNITS_SIZE;

//         console.log("num_of_discrete_Q: "+num_of_discrete_Q+" num_of_extra_req "+num_of_extra_req);


function iReturnTwo(input1, input2){
	var one = input1, two = input2;
	two = 2 * two;
	return [one, two];
}

var op = iReturnTwo(10, 6);

console.log('1: '+op[0]+' 2:'+op[1]);